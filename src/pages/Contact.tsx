...
const Contact = () => {
  ...
  return (
    <>
      {/* SEO */}
      <Helmet>
        <title>Contact Us - T-mart</title>
        <meta
          name="description"
          content="Get in touch with T-Mart – the B2B marketplace for website templates. Contact us for support, seller inquiries, or partnership opportunities."
        />
        <link rel="canonical" href="https://t-mart.online/contact" />
      </Helmet>

      {/* Banner */}
      <div className="relative bg-gradient-to-r from-brand-700 to-[#F72C5B] text-white py-16 px-6 text-center shadow-lg mb-10">
        ...
        <div className="flex flex-col-reverse md:flex-row gap-10 md:gap-0">
          ...
          <div className="space-y-6 px-4 md:px-0 flex flex-col justify-center mx-auto w-[100%]">
            <div>
              ...
              <p>
                B1/A, Ground Floor, Anand India Business Hub,<br/> Behind Shree Mahalaxmi Hospital,<br/> Deepak Hospital Road, Mira Road East,<br/> Thane – 401107.
              </p>
            </div>
            <div>
