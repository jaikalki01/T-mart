const LicenseAgreement = () => {
    return (
        <div className="container mx-auto p-6 max-w-[80rem] mt-[30px] mb-[30px]">
            ...
            <ul className="ml-6 mb-4 text-muted-foreground">
                <li><b>6.1 Free Templates:</b> Licensee must retain an attribution link to Tmart.com in the website footer unless an attribution-free license is purchased.</li>
...
posted on Tmart.com, and continued use of the Templates constitutes acceptance of the new
terms.</p>

            <p className="font-bold mt-6 text-muted-foreground  ">BY PURCHASING OR DOWNLOADING A TEMPLATE FROM TMART.COM, YOU ACKNOWLEDGE
