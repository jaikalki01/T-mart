...
const Index = () => {
  ...
  return (
    ...
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-brand-700 to-[#F72C5B] py-16 text-white">
        <div className="container space-y-8">
          ...
          >
            <Input
              ...
              className="h-12 flex-1 bg-white/20 text-white placeholder:text-white/70 backdrop-blur-sm focus:border-white/40"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <Button type="submit" className="h-12 bg-white text-[#F72C5B] hover:bg-white/90">
              Search Templates
            </Button>
          </form>
        </div>
      ...
      <section className="bg-accent py-16">
        <div className="container">
          ...
          <div className="mt-8 text-center">
            <Button asChild size="lg" className="bg-[#F72C5B] hover:bg-[#F72C5B]">
